...
router.post('/', publicApiLimiter, optionalAuth, createOrder);
router.get('/my', protect, getMyOrders);
router.get('/number/:orderNumber', publicApiLimiter, getOrderByNumber);
router.put('/number/:orderNumber/payment-screenshot', publicApiLimiter, optionalAuth, uploadPayment.single('screenshot'), uploadPaymentScreenshotByOrderNumber);
