...
export const themePresets = [
  ...
  },
  {
    ...
    colors: {
      ...
      accent: '#ddb457',
      accentSoft: '#f7e9ad',
      adminSidebarFrom: '#efabc0',
      adminSidebarVia: '#6fd6e6',
      adminSidebarTo: '#a1a7f4',
      heroGradientFrom: 'rgba(239, 171, 192, 0.92)',
      heroGradientVia: 'rgba(111, 214, 230, 0.9)',
      heroGradientTo: 'rgba(247, 233, 173, 0.84)',
    },
  },
];
...
const syncPresetTheme = async (themeSetting) => {
  if (!themeSetting || themeSetting.themeKey === 'custom-rgb') return themeSetting;
