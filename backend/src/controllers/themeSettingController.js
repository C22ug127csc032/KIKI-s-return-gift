...
export const themePresets = [
  ...
  },
  {
    ...
    colors: {
      ...
      accent: '#b89342',
      accentSoft: '#e6d4ac',
      adminSidebarFrom: '#d8a8b7',
      adminSidebarVia: '#5f97a8',
      adminSidebarTo: '#7b81b6',
      heroGradientFrom: 'rgba(129, 67, 97, 0.74)',
      heroGradientVia: 'rgba(53, 109, 134, 0.62)',
      heroGradientTo: 'rgba(85, 101, 159, 0.34)',
    },
  },
];
