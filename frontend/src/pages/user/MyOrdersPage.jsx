                  ...
                  <div className="p-5 flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-1.5">
                        ...
                        <span className="font-bold text-gray-800 text-sm font-mono">{order.orderNumber}</span>
                      </div>
                    ...
                    <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                      ...
                      <button onClick={() => downloadInvoice(order._id)}
                        className="p-2 text-gray-300 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors" title="Download Invoice">
                        <FiDownload size={15} />
                      </button>
